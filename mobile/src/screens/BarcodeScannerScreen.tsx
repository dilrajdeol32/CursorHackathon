    ...
    (qr: QRPatientData) => {
      ...
      if (appId) {
        ...
        Alert.alert(
          ...
          [{ text: "Scan Again", onPress: () => { setScanned(false); lockRef.current = false; } }]
        );
      }
    },
    [navigation]
      ...
      <SafeAreaView style={s.safe}>
        <View style={s.permWrap}>
          ...
          <Text style={s.permSub}>
            Scan patient wristband QR codes to quickly pull up their information.
          </Text>
        ...
        <View style={s.bottomArea}>
          ...
          {isSimulator && (
            <View style={s.demoSection}>
              <Text style={s.demoLabel}>Simulator: Tap a patient to simulate scan</Text>
              <View style={s.demoGrid}>
                {DEMO_QR_PATIENTS.map((p, i) => (
                  ...
                  >
                    ...
                    <Text style={s.demoName} numberOfLines={1}>{p.name}</Text>
...
const s = StyleSheet.create({
  ...
  cornerTL: { top: 0, left: 0, borderTopWidth: CORNER_W, borderLeftWidth: CORNER_W, borderColor: "#FFF", borderTopLeftRadius: 16 },
  cornerTR: { top: 0, right: 0, borderTopWidth: CORNER_W, borderRightWidth: CORNER_W, borderColor: "#FFF", borderTopRightRadius: 16 },
  cornerBL: { bottom: 0, left: 0, borderBottomWidth: CORNER_W, borderLeftWidth: CORNER_W, borderColor: "#FFF", borderBottomLeftRadius: 16 },
  cornerBR: { bottom: 0, right: 0, borderBottomWidth: CORNER_W, borderRightWidth: CORNER_W, borderColor: "#FFF", borderBottomRightRadius: 16 },
  bottomArea: { paddingBottom: 60, alignItems: "center" },
  instructions: { color: "rgba(255,255,255,0.8)", fontSize: 15, textAlign: "center", marginBottom: 20 },
  ...
  demoCard: { backgroundColor: "rgba(255,255,255,0.95)", borderRadius: radius.md, padding: 12, alignItems: "center", width: (SCREEN_W - 60) / 2, gap: 4 },
  ...
  permSub: { fontSize: 15, color: colors.mutedForeground, textAlign: "center", lineHeight: 22 },
  permText: { fontSize: 16, color: colors.mutedForeground },
  permBtn: { backgroundColor: colors.primary, paddingVertical: 14, paddingHorizontal: 32, borderRadius: radius.lg, marginTop: 8 },
